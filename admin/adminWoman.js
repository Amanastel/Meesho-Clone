...
function displayData(data) {
    ...
    function updateProduct(obj) {
        // console.log('update')
        fetch(`https://meesho.onrender.com/women/${obj.id}`,
            {
                method: 'PATCH',
                headers: {
                    'Content-type': 'application/json'
    ...
    function deleteProduct(id) {
        // console.log('update')
        fetch(`https://meesho.onrender.com/women/${id}`,
            {
                method: 'DELETE'
...
let mn = document.getElementById("men-id")
mn.addEventListener("click", ()=>{
    window.location.href = "adminMan.html"
})